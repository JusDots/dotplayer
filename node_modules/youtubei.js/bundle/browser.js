...
var require_tslib = __commonJS({
  "node_modules/tslib/tslib.js"(exports, module) {
    ...
    (function(factory) {
      ...
      __classPrivateFieldGet6 = /* @__PURE__ */ __name(function(receiver, state, kind, f) {
        if (kind === "a" && !f)
...
var Format = class {
  constructor(data2) {
    ...
    if (this.has_audio) {
      ...
      this.language = ((_b = (_a6 = url_components.get("xtags")) === null || _a6 === void 0 ? void 0 : _a6.split(":").find((x) => x.startsWith("lang="))) === null || _b === void 0 ? void 0 : _b.split("=").at(1)) || null;
...
var Playlist = class extends YTNode {
  constructor(data2) {
    ...
    this.title = new Text(data2.title);
    this.author = ((_a6 = data2.shortBylineText) === null || _a6 === void 0 ? void 0 : _a6.simpleText) ? new Text(data2.shortBylineText) : new Author(data2.longBylineText, data2.ownerBadges, null);
...
var Video = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "detaildMetadataSnippets")) {
...
var PlaylistHeader = class extends YTNode {
  constructor(data2) {
    ...
    this.author = new Author(Object.assign(Object.assign({}, data2.ownerText), { navigationEndpoint: data2.ownerEndpoint }), data2.ownerBadges, null);
    this.description = new Text(data2.descriptionText);
...
var YTNodeGenerator = class {
  static isIgnoredKey(key) {
    return typeof key === "string" && __classPrivateFieldGet(this, _a2, "f", _YTNodeGenerator_ignored_keys).has(key);
  }
  ...
  static createRuntimeClass(classname, key_info) {
    var _b, _key_info;
    __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_logNewClass).call(this, classname, key_info);
    const node = (_b = /* @__PURE__ */ __name(class extends YTNode {
      ...
      constructor(data2) {
        ...
        if (did_change) {
          ...
          __classPrivateFieldGet(YTNodeGenerator, _a2, "m", _YTNodeGenerator_logChangedKeys).call(YTNodeGenerator, classname, node.key_info, changed_keys);
        }
        ...
        for (const [key, value] of key_info2) {
          let snake_key = __classPrivateFieldGet(YTNodeGenerator, _a2, "m", _YTNodeGenerator_camelToSnake).call(YTNodeGenerator, key);
  ...
  static introspect(classdata) {
    const key_info = __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_introspect).call(this, classdata);
    const dependencies = /* @__PURE__ */ new Map();
    for (const [, value] of key_info) {
      if (value.type === "renderer" || value.type === "renderer_list")
        for (const renderer of value.renderers) {
          const example = __classPrivateFieldGet(this, _a2, "f", _YTNodeGenerator_renderers_examples)[renderer];
          if (example)
  ...
  static generateTypescriptClass(classname, key_info) {
    ...
    for (const [key, value] of key_info) {
      let snake_key = __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key);
      if (value.type === "misc" && value.misc_type === "NavigationEndpoint")
        snake_key = "endpoint";
...
`;
  ...
  static toTypeDeclaration(inference_type, indentation = 0) {
    switch (inference_type.type) {
      ...
      case "object": {
        return `{
${inference_type.keys.map(([key, value]) => `${" ".repeat((indentation + 2) * 2)}${__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key)}${value.optional ? "?" : ""}: ${this.toTypeDeclaration(value, indentation + 1)}`).join(",\n")}
      ...
      case "object":
        {
          ...
          parser = `{
${inference_type.keys.map(([key2, value]) => `${" ".repeat((indentation + 2) * 2)}${__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key2)}: ${this.toParser(key2, value, new_keypath, indentation + 1)}`).join(",\n")}
${" ".repeat((indentation + 1) * 2)}}`;
        }
        break;
      case "misc":
  ...
  static parse(key, inference_type, data2, key_path = ["data"]) {
    const should_optional = !inference_type.optional || __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data: data2 }, [...key_path, key]);
    switch (inference_type.type) {
      case "renderer": {
        return should_optional ? parser_default2.parseItem(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key]), inference_type.renderers.map((type) => parser_default2.getParserByName(type))) : void 0;
      }
      case "renderer_list": {
        return should_optional ? parser_default2.parse(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key]), true, inference_type.renderers.map((type) => parser_default2.getParserByName(type))) : void 0;
      }
      case "object": {
        const obj = {};
      ...
      case "misc":
        switch (inference_type.misc_type) {
          case "NavigationEndpoint":
            return should_optional ? new NavigationEndpoint_default(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key])) : void 0;
          case "Text":
            return should_optional ? new Text(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key])) : void 0;
          case "Thumbnail":
            return should_optional ? Thumbnail.fromResponse(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key])) : void 0;
          case "Author": {
            const author_should_optional = !inference_type.optional || __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_hasDataFromKeyPath).call(this, { data: data2 }, [...key_path, inference_type.params[0]]);
            return author_should_optional ? new Author(__classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
          }
        }
        throw new Error("Unreachable code reached! Switch missing case!");
      case "primative":
      case "unknown":
        return __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, key]);
    }
  }
  static inferType(key, value) {
    let return_value = false;
    if (return_value = this.isRenderer(value)) {
      __classPrivateFieldGet(this, _a2, "f", _YTNodeGenerator_renderers_examples)[return_value] = value[Reflect.ownKeys(value)[0]];
      return {
        type: "renderer",
    ...
    if (return_value = this.isRendererList(value)) {
      for (const [key2, value2] of Object.entries(return_value)) {
        __classPrivateFieldGet(this, _a2, "f", _YTNodeGenerator_renderers_examples)[key2] = value2;
      }
      return {
        type: "renderer_list",
...
The following keys where altered: ${changed_keys.map(([key]) => __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_camelToSnake).call(this, key)).join(", ")}
...
${this.generateTypescriptClass(classname, key_info)}`);
  ...
  const key_info = __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_passOne).call(this, classdata);
  return __classPrivateFieldGet(this, _a2, "m", _YTNodeGenerator_passTwo).call(this, key_info);
...
var Parser3 = class {
  static setParserErrorHandler(handler) {
    __classPrivateFieldSet(this, _a3, handler, "f", _Parser_errorHandler);
  }
  static parseResponse(data2) {
    var _b, _c;
    const parsed_data = {};
    __classPrivateFieldGet(this, _a3, "m", _Parser_createMemo).call(this);
    const contents = this.parse(data2.contents);
    const contents_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    if (contents) {
      parsed_data.contents = contents;
      parsed_data.contents_memo = contents_memo;
    }
    __classPrivateFieldGet(this, _a3, "m", _Parser_clearMemo).call(this);
    __classPrivateFieldGet(this, _a3, "m", _Parser_createMemo).call(this);
    const on_response_received_actions = data2.onResponseReceivedActions ? this.parseRR(data2.onResponseReceivedActions) : null;
    const on_response_received_actions_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_endpoints_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const on_response_received_commands_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const continuation_contents_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const actions_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    if (actions) {
    ...
    const live_chat_item_context_menu_supported_renderers_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    ...
    const header_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    if (header) {
    ...
    const sidebar_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    if (sidebar) {
    ...
    const streaming_data = data2.streamingData ? {
      ...
      formats: Parser3.parseFormats(data2.streamingData.formats),
      adaptive_formats: Parser3.parseFormats(data2.streamingData.adaptiveFormats),
    ...
    if (items) {
      ...
      parsed_data.items_memo = __classPrivateFieldGet(this, _a3, "m", _Parser_getMemo).call(this);
    }
    __classPrivateFieldGet(this, _a3, "m", _Parser_clearMemo).call(this);
    return parsed_data;
  }
  static parseItem(data2, validTypes) {
    ...
    if (!this.shouldIgnore(classname)) {
      try {
        ...
        __classPrivateFieldGet(this, _a3, "m", _Parser_addToMemo).call(this, classname, result);
        return result;
      } catch (err) {
        __classPrivateFieldGet(this, _a3, "f", _Parser_errorHandler).call(this, { classname, classdata: data2[keys[0]], err });
        return null;
      }
    }
    return null;
  ...
  static parseActions(data2) {
    if (Array.isArray(data2)) {
      return Parser3.parse(data2.map((action) => {
        delete action.clickTrackingParams;
        return action;
      }));
    }
...
This is a bug, please report it at ${Platform.shim.info.bugs_url}`));
  ...
  static getParserByName(classname) {
    const ParserConstructor = __classPrivateFieldGet(this, _a3, "f", _Parser_rt_nodes).get(classname);
  ...
  static hasParser(classname) {
    return __classPrivateFieldGet(this, _a3, "f", _Parser_rt_nodes).has(classname);
  }
  static addRuntimeParser(classname, ParserConstructor) {
    __classPrivateFieldGet(this, _a3, "f", _Parser_rt_nodes).set(classname, ParserConstructor);
    __classPrivateFieldGet(this, _a3, "f", _Parser_dynamic_nodes).set(classname, ParserConstructor);
  }
  static getDynamicParsers() {
    return Object.fromEntries(__classPrivateFieldGet(this, _a3, "f", _Parser_dynamic_nodes));
  }
};
__name(Parser3, "Parser");
_a3 = Parser3, _Parser_clearMemo = /* @__PURE__ */ __name(function _Parser_clearMemo2() {
  __classPrivateFieldSet(Parser3, _a3, null, "f", _Parser_memo);
}, "_Parser_clearMemo"), _Parser_createMemo = /* @__PURE__ */ __name(function _Parser_createMemo2() {
  __classPrivateFieldSet(Parser3, _a3, new Memo(), "f", _Parser_memo);
}, "_Parser_createMemo"), _Parser_addToMemo = /* @__PURE__ */ __name(function _Parser_addToMemo2(classname, result) {
  if (!__classPrivateFieldGet(Parser3, _a3, "f", _Parser_memo))
    return;
  const list = __classPrivateFieldGet(Parser3, _a3, "f", _Parser_memo).get(classname);
  if (!list)
    return __classPrivateFieldGet(Parser3, _a3, "f", _Parser_memo).set(classname, [result]);
  list.push(result);
  ...
  return __classPrivateFieldGet(Parser3, _a3, "f", _Parser_memo);
...
_Parser_errorHandler = { value: __classPrivateFieldGet(Parser3, _a3, "m", _Parser_printError) };
_Parser_memo = { value: null };
Parser3.ignore_list = /* @__PURE__ */ new Set([
  "AdSlot",
  "DisplayAd",
  "SearchPyv",
  "MealbarPromo",
...
_Parser_rt_nodes = { value: new Map(Array.from(Object.entries(nodes_exports2))) };
_Parser_dynamic_nodes = { value: /* @__PURE__ */ new Map() };
var parser_default2 = Parser3;
var ItemSectionContinuation = class extends YTNode {
  constructor(data2) {
    var _b, _c, _d;
    super();
    this.contents = Parser3.parseArray(data2.contents);
...
var AppendContinuationItemsAction2 = class extends YTNode {
  constructor(data2) {
    super();
    this.contents = Parser3.parseArray(data2.continuationItems);
  }
};
...
var ReloadContinuationItemsCommand = class extends YTNode {
  constructor(data2) {
    super();
    this.target_id = data2.targetId;
    this.contents = Parser3.parse(data2.continuationItems, true);
...
var SectionListContinuation = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.contents = Parser3.parse(data2.contents, true);
...
var GridContinuation = class extends YTNode {
  constructor(data2) {
    var _b;
    super();
    this.items = Parser3.parse(data2.items, true);
    this.continuation = ((_b = data2.continuations) === null || _b === void 0 ? void 0 : _b[0].nextContinuationData.continuation) || null;
  }
  get contents() {
    return this.items;
...
var LiveChatContinuation = class extends YTNode {
  constructor(data2) {
    ...
    super();
    this.actions = Parser3.parse((_b = data2.actions) === null || _b === void 0 ? void 0 : _b.map((action) => {
      delete action.clickTrackingParams;
      return action;
    }), true) || observe([]);
    this.action_panel = Parser3.parseItem(data2.actionPanel);
    this.item_list = Parser3.parseItem(data2.itemList, LiveChatItemList_default);
    this.header = Parser3.parseItem(data2.header, LiveChatHeader_default);
    this.participants_list = Parser3.parseItem(data2.participantsList, LiveChatParticipantsList_default);
    this.popout_message = Parser3.parseItem(data2.popoutMessage, Message_default);
...
var HTTPClient = class {
  ...
  fetch(input, init) {
    return __awaiter(this, void 0, void 0, function* () {
      const innertube_url = Constants_default.URLS.API.PRODUCTION_1 + __classPrivateFieldGet(this, _HTTPClient_session, "f").api_version;
...
var FormatUtils = class {
  ...
  static toDash(streaming_data, url_transformer = (url) => url, format_filter, cpn, player, actions) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      mpd.replaceWith(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "MPD", {
      ...
      yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_generateAdaptationSet).call(this, document, period, adaptive_formats, url_transformer, cpn, player, actions);
...
_a4 = FormatUtils, _FormatUtils_el = /* @__PURE__ */ __name(function _FormatUtils_el2(document, tag, attrs, children = []) {
    ...
    for (let i = 0; i < mime_types.length; i++) {
      if (mime_objects[i][0].has_audio && mime_objects[i][0].audio_track) {
        ...
        for (let j = 0; j < track_ids.length; j++) {
          ...
          children.push(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "Role", {
            schemeIdUri: "urn:mpeg:dash:role:2011",
            value: role
          }));
          const set = __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
            id: `${set_id++}`,
          ...
          for (const format of track_objects[j]) {
            yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
      } else {
        const set = __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
        ...
        for (const format of mime_objects[i]) {
          if (format.has_video) {
            yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_generateRepresentationVideo).call(this, document, set, format, url_transformer, cpn, player, actions);
          } else {
            yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const representation = __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "Representation", {
    ...
    yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_generateSegmentInformation).call(this, document, representation, format, (_g = url_transformer(url)) === null || _g === void 0 ? void 0 : _g.toString(), actions);
  });
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const representation = __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "Representation", {
      ...
      __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "AudioChannelConfiguration", {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if (format.is_type_otf) {
      ...
      const { resolved_url, segment_durations } = yield __classPrivateFieldGet(this, _a4, "m", _FormatUtils_getOTFSegmentInformation).call(this, url, actions);
      ...
      for (const segment_duration of segment_durations) {
        ...
        segment_elements.push(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "S", attributes));
      }
      representation.appendChild(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentTemplate", {
        startNumber: "1",
        timescale: "1000",
        initialization: `${resolved_url}&sq=0`,
        media: `${resolved_url}&sq=$Number$`
      }, [
        __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentTimeline", {}, segment_elements)
      ]));
    } else {
      if (!format.index_range || !format.init_range)
        throw new InnertubeError("Index and init ranges not available", { format });
      representation.appendChild(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "BaseURL", {}, [
        document.createTextNode(url)
      ]));
      representation.appendChild(__classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "SegmentBase", {
        indexRange: `${format.index_range.start}-${format.index_range.end}`
      }, [
        __classPrivateFieldGet(this, _a4, "m", _FormatUtils_el).call(this, document, "Initialization", {
  ...
  constructor(data2, actions, cpn) {
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_0 = this.watch_next_feed.at(-1)) === null || _0 === void 0 ? void 0 : _0.is(ContinuationItem_default)))
        __classPrivateFieldSet(this, _VideoInfo_watch_next_continuation, (_1 = this.watch_next_feed.pop()) === null || _1 === void 0 ? void 0 : _1.as(ContinuationItem_default), "f");
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    __classPrivateFieldSet(this, _HomeFeed_continuation, (_c = tab.content) === null || _c === void 0 ? void 0 : _c.as(SectionList_default).continuation, "f");
...
var Player = class {
  ...
  get url() {
    return new URL(`/s/player/${__classPrivateFieldGet(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, Constants_default.URLS.YT_BASE).toString();
  }
  get sts() {
...
var OAuth = class {
  ...
  revokeCredentials() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return __classPrivateFieldGet(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent(__classPrivateFieldGet(this, _OAuth_credentials, "f").access_token)}`, Constants_default.URLS.YT_BASE), {
        method: "post"
      });
    });
  }
...
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const response = yield __classPrivateFieldGet(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", Constants_default.URLS.YT_BASE), {
  ...
  const poller = setInterval(() => __awaiter(this, void 0, void 0, function* () {
    const data2 = Object.assign(Object.assign({}, __classPrivateFieldGet(this, _OAuth_identity, "f")), { code: device_code, grant_type: Constants_default.OAUTH.GRANT_TYPE });
    try {
      const response = yield __classPrivateFieldGet(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", Constants_default.URLS.YT_BASE), {
        body: JSON.stringify(data2),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  var _a6;
  return __awaiter(this, void 0, void 0, function* () {
    const response = yield __classPrivateFieldGet(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", Constants_default.URLS.YT_BASE), { headers: Constants_default.OAUTH.HEADERS });
    const response_data = yield response.text();
    const url_body = (_a6 = Constants_default.OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _a6 === void 0 ? void 0 : _a6[1];
    if (!url_body)
      throw new OAuthError("Could not obtain script url.", { status: "FAILED" });
    const script = yield __classPrivateFieldGet(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: Constants_default.URLS.YT_BASE });
...
var Kids = class {
  ...
  search(query) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Search_default2(__classPrivateFieldGet(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a6;
...
var Music = class {
  ...
  search(query, filters = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return new Search2(response, __classPrivateFieldGet(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return __awaiter(this, void 0, void 0, function* () {
